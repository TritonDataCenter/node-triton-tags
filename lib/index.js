...
var typeFromKey = {
    ...
    // The consumer of this tag is responsible for validating it is in fact
    // an ipv4 address.  In sdc-docker we do this via a call to napi.getIP()
    'triton.network.public_ipv4': 'string',
...
var validatorFromKey = {
    ...
    'triton.network.public_ipv4': function validateTritonNetworkPublicIpv4(val) {
        assert.string(val, 'val');
        return null;
    },
